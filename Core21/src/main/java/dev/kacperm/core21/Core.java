...
import dev.kacperm.core21.command.FactionCommand;
import dev.kacperm.core21.faction.FactionManager;
import dev.kacperm.core21.messages.impl.BalanceCommandMessages;
import dev.kacperm.core21.messages.impl.FactionCommandMessages;
...
import dev.kacperm.shared.command.registrar.RegisterAdvancedCommand;
...
public final class Core extends JavaPlugin implements SharedPlugin {
    ...
    public void loadCommands() {
        new RegisterSimpleCommand<>(this, new BalanceCommand(new BalanceCommandMessages())).register();
        new RegisterAdvancedCommand<>(this, new FactionCommand(new FactionCommandMessages())).register();
    }
